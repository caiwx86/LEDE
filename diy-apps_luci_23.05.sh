...
git_sparse_clone master  https://github.com/kiddin9/openwrt-packages luci-app-dockerman luci-app-nps luci-app-syncthing luci-app-turboacc luci-app-homeassistant luci-lib-taskd luci-app-homebridge
